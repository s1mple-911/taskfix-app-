...
- **SQL kutilmoqda**: 43, 45, 47, `TASKFIX_V8.sql`, `TASKFIX_PROJECT.sql`, `TASKFIX_SEARCH.sql` (ixtiyoriy — qidiruv indeksi, ilova busiz ham ishlaydi) (TaskFix); `PROVODKA_HODIM_KASSA.sql` (Provodka loyihasida).
